...
# by itself. The user doesnt know if the responses are coming back from the human
...
script = input("What is your problem?: ")
script = input("Have you had this problem before (yes or no)?: ")
if script == "yes" or "Yes":
