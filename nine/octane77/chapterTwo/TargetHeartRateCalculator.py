...
maximumHeartRate = int(220 - age)
print("Your maximum heart rate:", maximumHeartRate)
targetHeartRateLow = 0.5 * maximumHeartRate
targetHeartRateHigh = 0.85 * maximumHeartRate
print("Your target heart rate is {:.2f} - {:.2f}".format(targetHeartRateLow, targetHeartRateHigh))
